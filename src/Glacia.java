...
/**
 * Elite Four Glacia who holds a pokemon party to battle
 * @author Andrew
 *
 */
public abstract class Glacia extends Actor
{
	...
	{
		Pokemon[] temp = {new Pokemon("Glacia's Glalie"), new Pokemon("Glacia's Sealo"), new Pokemon("Glacia's Sealo"),new Pokemon("Glacia's Glalie"), new Pokemon("Glacia's Walrein")};
		party = temp;	
		...
		AlertBox.display("Uh Oh!", "Elite Four Glacia would like to battle!", "Let's Go!");
		...
		for(int i = 0; i < party.length; i++)
		{
			...
			{
				mp.stop();
				AlertBox.displayNoTitle("You have lost to Elite Four Glacia. Click OK to end your game!", "OK");
				break;
			}
			...
			{				
				if(i < party.length - 1)
				{
					...
					newPokemonAlert.setHeaderText("Elite Four Glacia is about to send out " + party[i+1].getName());
				...
				if(i == 5)
				{
					AlertBox.displayNoTitle("You beat Elite Four Glacia!", "OK");
					mp.stop();
